...
import { Command, CommandGroup, CommandItem, CommandList } from "@/components/common/ui/command";
      ...
      >
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            >
              <X className="absolute right-0 top-1/2 size-3 -translate-y-1/2 text-muted-foreground hover:text-foreground" />
            </button>
          </div>
        </div>
