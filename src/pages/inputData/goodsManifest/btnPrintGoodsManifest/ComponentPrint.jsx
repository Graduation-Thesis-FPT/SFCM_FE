...
export const ComponentPrint = forwardRef(({ rowData, vesselInfo, containerInfo }, ref) => {
  ...
  return (
    <div ref={ref} className="space-y-3 p-5">
      ...
      <div className="text-sm">
        Đề nghị đội Hải quan giám sát kho bãi cho chúng tôi được rút hàng vào kho các container hàng
        chung chủ sau đây vào kho SFCM
      </div>
      <div className="flex gap-10 text-sm font-bold">
        ...
        <div>
          NGÀY CẬP CẢNG:{" "}
          {vesselInfo.ETA ? moment(vesselInfo.ETA).format("DD/MM/Y HH:mm") : "...................."}
        </div>
      </div>
